...
function initLuxuryInteractions() {
    ...
    if (typeof flatpickr !== 'undefined') {
        ...
        if (checkinInput && checkoutInput) {
            // 1. Initialize the Checkout calendar first
            ...
            // 2. Initialize the Checkin calendar and link it to Checkout
            flatpickr(checkinInput, {
                ...
                onChange: function(selectedDates, dateStr, instance) {
                    if (selectedDates.length > 0) {
                        ...
                        // Force the checkout calendar to update its minimum allowed date
                        checkoutPicker.set('minDate', nextDay);
                        
                        // If they already picked a checkout date that is before the new check-in date, clear it
            ...
            // Fallback for pages that might just have generic date inputs
